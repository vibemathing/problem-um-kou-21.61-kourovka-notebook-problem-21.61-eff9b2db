...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.61"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-v1",
      "problem_contract_sha256": "b009b05b4f1b2465402f354695cedbc0b8ee296a5b7eb04c958fc49fb9061beb",
      "problem_id": "problem:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db",
      "route_id": "route:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-source-fidelity-01",
      "graph_id": "graph:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For a fixed (finitely generated free)-by-cyclic group $G=F_n\\rtimes\\mathbb Z$, is there an algorithm that, given a finite subset $S$ of $G$, finds a finite presentation for the subgroup $H=\\langle S\\rangle$?"
          },
          "statement_sha256": "ebaa6274b763c1fd759477fcf9e37435f67dc02fc775297301c19577af43e686"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-root",
      "route_id": "route:um-kou-21.61-kourovka-notebook-problem-21.61-eff9b2db-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.61-b26f63d38397",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.61"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
